      ...
      <div className="relative">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
            ...
            >
              <Label value="Cost (€)" position="bottom" offset={0} style={{ fill: "#64748B", fontSize: 11 }} />
            </XAxis>
            <YAxis
              type="number"
              dataKey="probability"
              ...
              tickFormatter={(v) => `${v}%`}
            >
              <Label value="Retention %" angle={-90} position="left" offset={5} style={{ fill: "#64748B", fontSize: 11 }} />
            </YAxis>
            <ReferenceLine x={20000} stroke="#64748B" strokeDasharray="6 4" strokeOpacity={0.5} />
            <ReferenceLine y={70} stroke="#64748B" strokeDasharray="6 4" strokeOpacity={0.5} />
            <Tooltip
        ...
        {/* Dot labels overlay */}
        {/* We use a custom label layer via the scatter shape instead */}
      </div>
